...
import { Film, AlertCircle, CheckCircle, Wrench } from 'lucide-react';
    ...
    <Link to={`/filmes/${movie.id}`}>
      <Card className="hover:shadow-lg transition-all duration-300 cursor-pointer h-full flex flex-col">
        ...
        <CardContent className="flex-1">
          ...
          <p className="text-sm text-muted-foreground mb-1">{movie.director}</p>
          <p className="text-xs text-muted-foreground">Ano: {movie.year}</p>
        </CardContent>
